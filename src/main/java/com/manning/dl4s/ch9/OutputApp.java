...
/**
 * Simple app to output search results using different similarities / ranking functions
 */
public class OutputApp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    wv.setSimilarity(new WordEmbeddingsSimilarity(word2Vec, fieldName, WordEmbeddingsSimilarity.Smoothing.TF_IDF));
